...
class SpaceManagement extends BasePage {
  constructor(page) {
    ...
    this.BuildOrganisationTrees = "div[aria-label='Building spaces Process step item']";
    ...
    this.LocateOrganisation = "div[aria-label='Locate organisations Process step item']";
